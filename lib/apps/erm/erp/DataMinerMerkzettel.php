 ...
 */
class	DataMinerCuCart	extends	DataMiner	{
	/**
	 * __construct
	 * 
	 ...
	 */
	function	getTableCuCartOpen( $_key, $_id, $_val) {
		$ret	=	"" ;
		...
		$ret	=	$myObj->tableFromDb( ",K.FirmaName1 ",
								...
								"C.Status < 90 ",
								"ORDER BY C.CuCartNo DESC ",
								"ResultSet",
								"CuCart",
								"C.CuCartNo, C.Datum, K.FirmaName1") ;
		error_log( $ret) ;
		return $ret ;
	}
}

...
class	CustomerInvoiceItem	extends	AppObjectERM	{
	...
	private	static	$rPosType	=	array (
						CustomerInvoiceItem::NORMAL	=> "Normal",
						CustomerInvoiceItem::LFRNG	=> "Liefern",
						CustomerInvoiceItem::RCHNG	=> "Berechnen",
						CustomerInvoiceItem::KOMP		=> "Komponente",
						CustomerInvoiceItem::HDLGPSCH	=> "Handling",
						CustomerInvoiceItem::VRSND	=> "Versand"
					) ;
	/**
	 *
	 */
	function	__construct( $_cuOrdrNo="") {
		parent::__construct( "auf_pos", "ap_id") ;
		$this->AuftragNr	=	$_cuOrdrNo ;
	}
	/**
	 *
	 * @return void

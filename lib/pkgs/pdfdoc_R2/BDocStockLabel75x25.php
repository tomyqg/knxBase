...
/**
 * BDocStockLabel75x25.php Base class for PDF-format based label for Article with
 ...
 * @subpackage PDFDoc
 */
class	BDocStockLabel75x25 extends BDoc	{
	...
	function	__construct() {
		error_log( "BDocStockLabel75x25::__construct() ") ;
		BDoc::__construct() ;

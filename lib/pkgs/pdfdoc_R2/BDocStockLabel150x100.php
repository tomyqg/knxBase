 ...
 * @subpackage PDFDoc
 */
class	BDocStockLabel150x100 extends BDoc	{
	...
	function	__construct() {
		...
		$this->label->addFrame( $this->frmBarcode=new BFrame( $this, "Barcode", "", 4, 4, 142, 92)) ;

		/**
		 * setup the default formats
		 */
		$this->defCharFmt	=	new BCharFmt() ;
		$this->defCharFmt->setCharSize( 14) ;
		...
		$this->hdrCharFmt->setCharSize( 20.0) ;	// 14pt font
		...
		$this->bcCharFmt->setCharStretch( 200) ;
		...
		$this->bctCharFmt->setCharSize( 24.0) ;

...
/**
 * BDocArtLbl55x25.php Base class for PDF-format based label for Article with
 ...
 * @subpackage PDFDoc
 */
class	BDocArtLbl55x25 extends BDoc	{
	...
	function	__construct() {
		FDbg::dumpL( 0x00010000, "BDocArtLbl55x25.php:.BDocArtLbl55x25::__construct(): begin\n") ;
		BDoc::__construct() ;
		...
		$this->label->addFrame( $this->frmContent=new BFrame( $this, "Content", "Auto", 2, 2, 51, 13)) ;
		$this->label->addFrame( $this->frmFooter=new BFrame( $this, "Footer", "", 0, 0, 0, 0)) ;
		$this->label->addFrame( $this->frmBarcode=new BFrame( $this, "Barcode", "", 4, 13, 47, 14)) ;

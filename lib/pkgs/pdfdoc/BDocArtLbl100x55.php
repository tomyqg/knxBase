...
/**
 * BDocArtLbl100x55.php Base class for PDF-format based label for Article with
...
/**
 * BDocArtLabel100x55 - Class for the Label
 *
 ...
 * @subpackage PDFDoc
 */
class	BDocArtLbl100x55 extends BDoc	{
	...
	function	__construct() {
		FDbg::dumpL( 0x00010000, "BDocArtLbl100x55.php:.BDocArtLbl100x55::__construct(): begin\n") ;
		BDoc::__construct() ;
		BDoc::setSize( BDoc::DocSizeLbl100x55) ;
		...
		$this->label->addFrame( $this->frmContent=new BFrame( $this, "Content", "Auto", 2, 2, 96, 39)) ;
		$this->label->addFrame( $this->frmFooter=new BFrame( $this, "Footer", "", 0, 0, 0, 0)) ;
		$this->label->addFrame( $this->frmBarcode=new BFrame( $this, "Barcode", "", 4, 43, 92, 10)) ;
		...
		$this->bcCharFmt->setCharStretch( 50) ;

...
class	BDocRegLetter extends BDoc	{
	...
	function	setupFooter( $_frm) {
		...
		$this->myfpdf->Text( $_frm->horOffs, $_frm->verOffs + 32, "<GESCH€FTSF†HRER?>" );
	...
	function	setupRcvrField( $_frm) {
		 ...
		 */
		$this->myfpdf->Text( $_frm->horOffs, $_frm->verOffs + $relVerOffs, "<FIRMENNAME>, <MEINE STRASSE> x, D-00000 Irgendwo" ) ;
		$relVerOffs	+=	mmToPt( 1) ;

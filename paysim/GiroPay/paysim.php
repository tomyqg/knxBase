	...
	<table>
		<tr>
			<td>
				...
				<form name="notifyPay" method="post" action="<?php echo $_POST['urlNotify']."&gpCode=4000&gpHash=HASH" ; ?>"
					target="payNotify">
					<input type="submit" value="Payment ok" />
				</form>
			</td>
		...
		<tr>
			<td>
				...
				<form name="notifyPay" method="get" action="<?php echo $_POST['urlNotify']."&gpCode=4900&gpHash=HASH" ; ?>"
					target="notifyPay">
					<input type="submit" value="User cancellation" />
				</form>
			</td>

...
$startNode	=	exportXML( $xmldoc, $xmldoc) ;
...
function        exportXML( $_doc, $_node) {
	$allusersNode	=	$_doc->appendChild( $_doc->createElement( "allusers")) ;
	$userNode	=	$allusersNode->appendChild( $_doc->createElement( "user")) ;
	$uidNode	=	$userNode->appendChild( $_doc->createElement( "uid")) ;
	$user		=	$uidNode->appendChild( $_doc->createTextNode( "berta")) ;
	$userNode	=	$allusersNode->appendChild( $_doc->createElement( "user")) ;
	$uidNode	=	$userNode->appendChild( $_doc->createElement( "uid")) ;
	$user		=	$uidNode->appendChild( $_doc->createTextNode( "caesar")) ;
	$userNode	=	$allusersNode->appendChild( $_doc->createElement( "user")) ;
	$uidNode	=	$userNode->appendChild( $_doc->createElement( "uid")) ;
	$user		=	$uidNode->appendChild( $_doc->createTextNode( "detlef")) ;
	return $dataXML ;
}

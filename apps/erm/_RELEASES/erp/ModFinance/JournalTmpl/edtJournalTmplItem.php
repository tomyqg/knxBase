	...
	<div id="maindata">
		<form name="editorObject" id="editorObject" onsubmit="return false ;"> 
			<table><?php
				...
				rowEdit( FTr::tr( "Debit Account"), "_IAccountDebit", 32, 32, "", "") ;
				rowEdit( FTr::tr( "Credit Account"), "_IAccountCredit", 32, 32, "", "") ;
				rowEdit( FTr::tr( "Debit Amount %"), "_FAmountDebit", 8, 8, "", "") ;
				rowEdit( FTr::tr( "Credit Amount %"), "_FAmountCredit", 8, 8, "", "") ;
				?></table>

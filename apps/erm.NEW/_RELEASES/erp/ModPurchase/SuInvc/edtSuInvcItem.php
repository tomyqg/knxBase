...
<div id="content">
	<div id="maindata">
		<form action="AdrBearb.php" method="post" name="editorObject" enctype="multipart/form-data" target="Adr" onsubmit="return false ;"> 
			<table><?php
				rowDisplay( FTr::tr( "Id"), "_HId", 8, 8, "", "") ;
				rowDisplay( FTr::tr( "Adress no."), "_HKey", 12, 12, "", "") ;
				rowEdit( FTr::tr( "Address addition"), "_IAdrZusatz", 24, 32, "") ;
				...
				rowEdit( FTr::tr( "User name"), "_IBenutzerName", 16, 16, "", "") ;

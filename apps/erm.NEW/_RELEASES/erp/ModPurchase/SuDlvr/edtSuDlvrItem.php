	...
	<div id="maindata">
		<form name="editorObject" id="editorObject" onsubmit="return false ;"> 
			<table><?php
				...
				rowEdit( FTr::tr( "Qty. delivered already"), "_IMengeBereitsEmpfangen", 16, 16, "", "") ;
				rowEdit( FTr::tr( "Qty. delivered"), "_IMengeEmpfangen", 16, 16, "", "") ;
				rowEdit( FTr::tr( "Qty. per pack"), "_IMengeProVPE", 16, 16, "", "") ;
				rowEdit( FTr::tr( "Price"), "_FPreis", 16, 16, "", "") ;
				rowDisplay( FTr::tr( "Price total"), "_FGesamtPreis", 16, 16, "", "") ;
				?></table>

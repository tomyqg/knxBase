...
<html dir="ltr">
	...
	<head>
		...
		<title>Immobilien Management - <?php echo $mySysSession->ClientId ; ?></title>
		<script>
...
-->
<link rel="stylesheet" type="text/css" href="/rsrc/toolkits/jquery-ui-1.12.0.custom/jquery-ui.min.css">
<link rel="stylesheet" type="text/css" href="/rsrc/toolkits/fullcalendar-2.9.0/fullcalendar.min.css"></script>
<script type="text/javascript" src="/rsrc/toolkits/jquery-3.1.0.min.js" ></script>
<script type="text/javascript" src="/rsrc/toolkits/jquery-ui-1.12.0.custom/jquery-ui.min.js" ></script>
<script type="text/javascript" src="/rsrc/toolkits/fullcalendar-2.9.0/lib/moment.min.js"></script>
<script type="text/javascript" src="/rsrc/toolkits/fullcalendar-2.9.0/fullcalendar.min.js"></script>
<!--
...
-->
		...
		<!--
		 ...
		 --
		 -->
		<link rel="stylesheet" type="text/css" media="screen" href="/api/loadCSS.php?sessionId=<?php echo $mySysSession->SessionId ; ?>&css=immo_man.css" title="Default" />
		<!--				-->
		<script>
function	onLoad() {
//	dOpen( 9) ;
...
function	showBarRight() {
	...
	<?php
		function	showLeftMenu( $_parent="", $_level=1) {
			...
			FDbg::trace( 0, FDbg::mdTrcInfo1, basename( __FILE__), "*". __METHOD__."( '$_parent')", "line := {".__LINE__."}") ;
			...
			foreach ( $module as $key => $mod) {
				FDbg::trace( 0, FDbg::mdTrcInfo1, basename( __FILE__), "*". __METHOD__."( '$_parent')", "key := {$key}, mod := {$mod}") ;

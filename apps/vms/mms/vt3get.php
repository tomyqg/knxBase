...
case	'getList'	:
	$myMember	=	new Member() ;
	$jsonData	=	$myMember->getListAsJSON( "", -1, "Member", null) ;
	break ;
case	'getThis'	:
	$myMember	=	new Member() ;
	$myMember->setKey( $_REQUEST[ "MemberNo"]) ;
	$jsonData	=	$myMember->getJSON() ;
	break ;
case	'getPrev'	:
	$myMember	=	new Member() ;
	$myMember->setKey( $_REQUEST[ "MemberNo"]) ;
	$jsonData	=	$myMember->getJSONPrev() ;
	break ;
case	'getNext'	:
	$myMember	=	new Member() ;
	$myMember->setKey( $_REQUEST[ "MemberNo"]) ;
	$jsonData	=	$myMember->getJSONNext() ;
	break ;
case	'getContacts'	:
	$myMember	=	new Member() ;
	$myMember->setKey( $_REQUEST[ "MemberNo"]) ;
	$jsonData	=	$myMember->getListAsJSON( "", -1, "MemberContact", null) ;
	break ;
case	'getPeriods'	:
	$myMember	=	new Member() ;
	$myMember->setKey( $_REQUEST[ "MemberNo"]) ;
	$jsonData	=	$myMember->getListAsJSON( "", -1, "MemberPeriod", null) ;
	break ;
	
case	'save'		:
	$myMember	=	new Member() ;
	$myMember->setKey( $_REQUEST[ "MemberNo"]) ;
	if ( $myMember->upd( "", -1, "Member", null)) {

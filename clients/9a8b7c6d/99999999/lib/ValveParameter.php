<?php
/**
 * ValveParameter.php - Class definition
 *  Domain:
 *  	- administrative
 * 	ValveParameter references:
 * 		- n/a
 *  ValveParameter is referenced by:
 *  	- TrailerType
 *  	- Calculation (twice!)
 *
 ...
 * @version 0.1
 * @package ValveParameterCalc
 */
/**
 * ValveParameter - User-Level Class for usage by the application
 *
 ...
 * @subpackage Classes
 */
class	ValveParameter	extends	BCObject	{
	/*
	...
	function	__construct() {
		parent::__construct( "ValveParameter", "Id") ;
//		parent::setIdKey( "h_key") ;
	...
	function	getXMLComplete( $_key="", $_id=-1, $_val="") {
		...
		$ret	.=	$this->getTableDepAsXML( $_key, $_id, "ValveParameter") ;
		return $ret ;
	}
	/**
	 * (non-PHPdoc)
		...
		switch ( $_val) {
			default	:
				if ( $_id >= 0) {
					...
					$newItem	=	new $_val ;
					$newItem->ValveParameterId	=	$this->ValveParameterId ;
	...
	function	getList( $_key="", $_id=-1, $_val="", $reply=null) {
		FDbg::begin( 1, "ValveParameter.php", "ValveParameter", "getListAsXML( '$_key', $_id, '$_val')") ;
		if ( $reply == null)

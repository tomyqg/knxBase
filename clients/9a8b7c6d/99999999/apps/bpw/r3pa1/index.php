...
sessionId		=	"<?php echo $mySysSession->SessionId ; ?>" ;
		...
		<style type="text/css" media="screen">
			...
			.sprite-folded { width: 16px; height: 16px; background:url(/jQuery/jquery-ui-1.8.23.custom/css/cupertino/images/ui-icons_3d80b3_256x240.png) no-repeat -32px -16px; }
			.sprite-unfolded { width: 16px; height: 16px; background:url(/jQuery/jquery-ui-1.8.23.custom/css/cupertino/images/ui-icons_3d80b3_256x240.png) no-repeat -64px -16px; }
		</style>
...
//};
	...
	<body onload="onLoad()" id="page">
		...
		<div id="toolBar">&nbsp;&nbsp;
			...
			<img src="/clients/99999999/rsrc/icons/16x16/row 2/1.png" title="Delete this trailer"/>&nbsp;
			...
			<img src="/clients/99999999/rsrc/icons/16x16/row 11/5.png" title="Create New Trailer" onClick="hook() ;" />&nbsp;
		</div>
		...
		<div id="centerContainer">
			<div id="centerLeft">
				<div id="Navigator">
					<div class="g1p" onClick="showScreen( 'trailer', false) ; return false ;">Trailer</div>
					<div class="g1p" onclick="fold( 'Calculate') ; return false ;">Calculation</div>
					<div id="Calculate" data-wap-fold="true" style="display: none;">
						<div class="g2p" onclick="showScreen( '01_vehicleType', false) ; return false ;">Vehicle Type</div>
						<div class="g2p" onclick="showScreen( '02_vehicleData', false) ; return false ;">Vehicle Data</div>
						<div class="g2p" onclick="showScreen( '03_axle', false) ; return false ;">Axle</div>
						<div class="g2p" onclick="showScreen( '04_brakes', false) ; return false ;">Brakes</div>
						<div class="g2p" onclick="showScreen( '05_tyres', false) ; return false ;">Tyres</div>
						<div class="g2p" onclick="showScreen( '06_brakeSystem', false) ; return false ;">Brakesystem</div>
						<div class="g2p" onclick="showScreen( '07_cylinders', false) ; return false ;">Cylinders</div>
						<div class="g2p" onclick="fold( '08_evaluation', false) ; return false ;">Evaluation</div>
						<div id="08_evaluation" data-wap-fold="true" style="display: none;">
							<div class="g3p" onclick="showScreen( '08.01_type_0', false) ; return false ;">Type 0</div>
							<div class="g3p" onclick="showScreen( '08.02_type_I', false) ; return false ;">Type I</div>
							<div class="g3p" onclick="showScreen( '08.03_type_II', false) ; return false ;">Type II</div>
							<div class="g3p" onclick="showScreen( '08.04_type_III', false) ; return false ;">Type III</div>
						</div>
					</div>
<?php
						if ( $appUser->isGranted( "scr", "ModMainData")) {
?>
					<div class="g1p" onclick="fold( 'ModMainData') ; return false ;">Main Data</div>
					<div id="ModMainData" data-wap-fold="true" wapisloaded="true" style="display: none;">
						<div class="g2p" onclick="showScreen( 'assessment', false) ; return false ;">Assessment</div>
						<div class="g2p" onclick="showScreen( 'Brake', false) ; return false ;">Brakes</div>
						<div class="g2p" onclick="showScreen( 'tyre', false) ; return false ;">Tyres</div>
						<div class="g2p" onclick="showScreen( 'valve', false) ; return false ;">Valves</div>
					</div>
<?php
						}
?>
...
?>
			...
			<div id="center">
				...
				<div id="trailer" style="display: none;" data-wap-screen="trailer.xml" data-wap-screen-dir="Trailer" data-wap-module-dir="ModCalc"></div>
				<div id="assessment" data-wap-screen="assessment.xml" style="display: none;" data-wap-screen-dir="Assessment" data-wap-module-dir="ModMainData"></div>
				<div id="Brake" data-wap-screen="brake.xml" style="display: none;" data-wap-screen-dir="Brake" data-wap-module-dir="ModMainData"></div>
				<div id="tyre" data-wap-screen="tyre.xml" style="display: none;" data-wap-screen-dir="Tyre" data-wap-module-dir="ModMainData"></div>
				<div id="valve" data-wap-screen="valve.xml" style="display: none;" data-wap-screen-dir="Valve" data-wap-module-dir="ModMainData"></div>
